...
export class SearchResponsibleDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.builder.group({
      ...
      address: [`${this.responsibles.address} หมู่ที่ ${this.responsibles.r_villagecode} หมู่บ้าน ${this.responsibles.villagename} ตำบล ${this.responsibles.tambonname} อำเภอ ${this.responsibles.ampurname} จังหวัด ${this.responsibles.changwatname} 
      `, Validators.required]
    });
